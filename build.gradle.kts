...
paperweight {
    serverProject.set(project(":mpe-server"))
    ...
    useStandardUpstream("pearl") {
        ...
        ref.set(providers.gradleProperty("pearlRef"))
        ...
        withStandardPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("mpe-api"))
            serverOutputDir.set(layout.projectDirectory.dir("mpe-server"))
    }
}
